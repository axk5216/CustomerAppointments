...
/**
 * Report 3
 * Schedule for each user in organization including appointment ID, title, type, and description, start, end, customer ID.
 * Populate table view with information and allow user to manipulate.
 *
 * @author Aaron Kephart
 */
public class Report3User implements Initializable {
    ...
    @FXML
    private ComboBox<User> typeCombo;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        typeCombo.setItems(ListManager.getAllUsers());
    ...
    public void typeComboOnAction(ActionEvent actionEvent) throws SQLException {
        ...
        appointments.setItems(ListManager.getUserAppointment(typeCombo.getValue()));
